...
class UserLogin(Resource):
    ...
    def post(self):
        ...
        return prepare_response({'message':'Invalid credentials'},401)
...
class TokenRefresh(Resource):
    ...
    def post(self):
        ...
        return prepare_response({'access_token': new_token},200)
...
class UserLogout(Resource):
    ...
    def post(self):
        jti=get_jti()
        BLACKLIST.add(jti)
        return prepare_response({'message':'User successfully logged out'},200)
...
class UserAccount(Resource):
    ...
    def get(self,User_Name):
        ...
        if user:
            return prepare_response(user.json(),200) 
...
class GetMail(Resource):
    ...
    def post(self):
        ...
        server.close()
        return prepare_response({'message':'Mail sent!'},200)
